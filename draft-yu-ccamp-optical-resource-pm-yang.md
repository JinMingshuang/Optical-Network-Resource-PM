...
title: A YANG Data Model for Device-level Resource Performance Monitoring
...
This document defines a YANG data model for device-level resource performance Monitoring which provides the functionalities of retrieval of device-level performance monitoring capabilities, TCA (Threshold Crossing Alert) configuration, current or history performance data retrieval, and performance monitoring task management. This data model should be used in the northbound of network controller.
...
Device-level resource performance monitoring is a basic function of network management. By viewing and analyzing the performance data of the device-level resource such as network element, interface, board, termination point, tunnel termination point, operators can detect the running state of devices in time, quickly resolve real-time problems or identify major risks in advanced , avoiding users' complaints. 
...
In summary, there is no data model/ mechanism to satisfy the above-mentioned performance monitoring requirements at device-level. This document defines a YANG module for device-level performance monitoring, which defines the capabilities of device-level resource performance monitoring, the tca configuration model of a specific resource. In addition, the sub-module of monitoring task and a few RPCs are defined to support the operations of performance monitoring, such as data retrieval and controlling the monitoring tasks. 
...
| ------ | --------------------------------- | --------- |
| dvcrpm | ietf-device-resource-pm          | RFC XXXX  |
|dvcrpm-types| ietf-device-resource-pm-types    | RFC XXXX  |
...
# YANG Data Model for Device-level Resource Performance Monitoring

## Capabilities of Device-level Performance Monitoring
...
## Data Retrieval of Device-level Resource Performance Monitoring
...
## Controlling of Device-level Resource Performance Monitoring
...
# Device-level Resource Performance Monitoring Tree Diagram

~~~~ ascii-art
{::include ./ietf-device-resource-pm.tree}
~~~~
{: #fig-rpm-tree title="Device-level Resource Performance Monitoring tree diagram"
artwork-name="ietf-device-resource-pm.tree"}

# YANG Model for Device-level Resource Performance Monitoring

~~~~ yang
{::include ./ietf-device-resource-pm.yang}
~~~~
{: #fig-rpm-yang title="Device-level Resource Performance Monitoring YANG module"
sourcecode-markers="true" sourcecode-name="ietf-device-resource-pm.yang"}

# YANG Model for Device-level Resource Performance Monitoring Types

~~~~ yang
{::include ./ietf-device-resource-pm-types.yang}
~~~~
{: #fig-rpm-type-yang title="Device-level Resource Performance Monitoring Types YANG module"
sourcecode-markers="true" sourcecode-name="ietf-device-resource-pm-types.yang"}
...
This document registers following YANG modules in the YANG Module Names registry {{!RFC6020}}.
   ...
   name:         ietf-device-resource-pm
   namespace:    urn:ietf:params:xml:ns:yang:ietf-device-resource-pm
   prefix:       dvcrpm
   reference:    RFC XXXX: A YANG Data Model for Device-level Resource Performance Monitoring

   name:         ietf-device-resource-pm-types
   namespace:    urn:ietf:params:xml:ns:yang:ietf-device-resource-pm-types
   prefix:       dvcrpm-types
   reference:    RFC XXXX: A YANG Data Model for Device-level Resource Performance Monitoring
